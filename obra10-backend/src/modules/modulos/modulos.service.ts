...
export class ModulosService {
  ...
  async findAll() {
    ...
    return modulos.map((m: any) => ({
      ...
      precoBasico: Number(m.precoBasico || 0),
      precoAnualBasico: Number(m.precoAnualBasico || 0),
      precoEnterprise: Number(m.precoEnterprise || 0),
      precoAnualEnterprise: Number(m.precoAnualEnterprise || 0),
      versao: m.versao,
